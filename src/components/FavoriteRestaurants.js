...
export class FavoriteRestaurants extends Component {
    ...
    deleteAnswer = () => {
        console.log("delete");
        fetch(`https://datenight-api.herokuapp.com/user/${localStorage.loggedInUserId}/favorite_places/${this.props.favePlace.id}`, {
            method: "DELETE",
        })
        .then(r => {
            this.props.mount()
    ...
    render() {
        return (
                ...
                <div style={{'display': 'flex', 'flex-direction': 'row', 'flex-wrap': 'wrap', 'justify-content': 'space-around', 'align-items': 'space-around', 'height': '100%', 'margin-top': '16px'}}>
                    ...
                    <h6 style={{"margin-top":"10px"}}><a href={this.props.favePlace.url} target="_blank">Visit Yelp Page</a></h6><br/>
